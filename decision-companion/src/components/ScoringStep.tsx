  ...
  return (
    <div className="animate-fade-in">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-800">Rate each option</h2>
        <p className="text-slate-600 mt-2">
          Score each option against every criterion. Use a scale of 1-10 or enter actual values.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 mb-6">
        ...
        <div className="w-full h-3 bg-slate-200 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-primary-500 to-primary-600 rounded-full transition-all duration-500 progress-bar"
                      ...
                      <td key={criterion.id} className="px-4 py-4 text-center">
                        <div className="relative">
                          <input
                            ...
                            className={`
                              w-full max-w-[100px] mx-auto px-3 py-2 text-center border rounded-lg
